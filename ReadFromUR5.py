...
class ReadFromRobot:
    def __init__(self): # TODO Omer
        HOST = "132.72.96.97"  # The remote host
        PORT_30003 = 30003
        # This Program Read all the Data from the UR5 only one time
        ...
        while count == 0:
            if program_run == 0:
                try:
                    ...
                    self.packet_1 = s.recv(4)
                    self.packet_2 = s.recv(8)
